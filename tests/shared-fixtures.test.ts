...
const FIXTURES: Record<string, { checksum: string; path: string }> = {
  "valid-catalog.json": {
    checksum: "f178e142cf30d5fcf34809eaf4278fb9a802100833f3fef52a5c4655c2b712ce",
    path: "../../moe-icons-package-maker/tests/fixtures/schemas/valid-catalog.json",
  },
  "valid-partial-manifest.json": {
    checksum: "1286febe325d5c9b8d39cb549d45b8585a6c161d0b012e6d1d6d9b034015396f",
    path: "../../moe-icons-package-maker/tests/fixtures/schemas/valid-partial-manifest.json",
  },
  "invalid-manifest.json": {
    checksum: "b73df13191aa3beea1abc5b934e29a5a604ca748b91b4f20f3c344243d3290e8",
    path: "../../moe-icons-package-maker/tests/fixtures/schemas/invalid-manifest.json",
  },
};

...
/** ASCII banner generated by scripts/generate-banner.mjs (figlet, Standard font). */
const slash = String.fromCharCode(92);
export const MOEICONS_BANNER = [
  "",
  "  __  __  ___  _____ ___ ____ ___  _   _ ____",
  ` |  ${slash}/  |/ _ ${slash}| ____|_ _/ ___/ _ ${slash}| ${slash} | / ___|`,
  " | |" + slash + "/| | | | |  _|  | |  | | | |  " + slash + "| " + slash + "___ " + slash,
  ` | |  | | |_| | |___ | | |__| |_| | |${slash}  |___) |`,
  ` |_|  |_|${slash}___/|_____|___${slash}____${slash}___/|_| ${slash}_|____/`,
  "",
].join("\n");
...
export function renderBannerText(): string {
  return `${MOEICONS_BANNER}\n${renderNoticeBox(CLI_NOTICE_LINES)}\n`;
}
